...
def prep_pos(cleaned_file , distname , year , month):
    try:
        ...
        prepared_file = prepared_file[[
            "item_code", "item_name", "brick_code", "territory_name","sales_units", "bonus_units", "dist_name","year","month"]]
